...
% 	>> conda.init
%
% NOTE: Some users have issues with virtual environment control from inside MATLAB.
% If you are experiencing issues where UMAP cannot find a Python module,
% try running matlab from the terminal like so:
% 	$ conda activate crabsort-umap
% 	$ matlab


function self = UMAP(self)
